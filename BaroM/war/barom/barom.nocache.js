...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "barom" because\n';
 ...
 * "/barom.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['barom'].superdevmode = true;

  var expectedSuffix = '/barom.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + barom + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:barom';
  var devModeSessionKey = '__gwtDevModeSession:barom';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/barom/barom.nocache.js';
  ...
  $wnd.__gwt_activeModules['barom'].canRedirect = true;
  $wnd.__gwt_activeModules['barom'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/barom?user.agent=' + ua + '&_callback=' + callback;
